...
%NIRCMD% speak text You,Opened,The,command 1,9 100
PING -n %Pause% 192.168.1.1 >NUL
exit

:2
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text You,Opened,The,command,Folder 1,9 100
PING -n %Pause% 192.168.1.1 >NUL
exit

:3
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text This,Is,The,command 1,9 100
PING -n %Pause% 192.168.1.1 >NUL
exit

:4
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text This,Is,The,command,Folder 1,9 100
PING -n %Pause% 192.168.1.1 >NUL
exit
