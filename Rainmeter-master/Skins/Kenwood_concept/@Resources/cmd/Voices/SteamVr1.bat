...
%NIRCMD% speak text You,Opened,Steam,VR 1,9 100
exit

:2
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text You,Opened,Steam,Powerd,Virtual,Reallity 1,9 100
exit

:3
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text This,Is,Steam,CR 1,9 100
exit

:4
set "NIRCMD=%UserProfile%\Documents\Rainmeter\Skins\Kenwood_concept\@Resources\Programs\nircmd.exe"
%NIRCMD% speak text This,Is,Steam,Powerd,Virtual,Reallity 1,9 100
exit
